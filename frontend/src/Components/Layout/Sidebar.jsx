...
export default function Sidebar() {
  ...
  const isActive = (path) => {
    return location.pathname === path
      ...
      : "text-black hover:bg-white/5 hover:text-[#C59D5F]";
  };
  ...
  return (
    <div className="flex h-screen font-['Inter'] relative z-40">
      ...
      <div
        ...
        } bg-[#F1F5F9] border-r border-[#E2E8F0] transition-all duration-300 ease-in-out flex flex-col h-full overflow-hidden`}
      >
        {/* Header - Changed to bg-[#E2E8F0] */}
        <div className="h-20 flex items-center justify-center border-b border-[#E2E8F0] bg-[#E2E8F0]">
          <h2
            className={`font-['Barlow_Condensed'] font-bold text-2xl uppercase tracking-widest text-[#1E293B] ${
              !isOpen && "lg:hidden"
            }`}
          >
            {/* LOGO */}
