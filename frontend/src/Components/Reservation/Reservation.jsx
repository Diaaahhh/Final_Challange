...
export default function Reservation() {
  ...
  // --- STYLES FOR INPUTS ---
  // Added 'bg-gray-800 text-white' to ensure visibility on all devices
  const inputClass =
    "input input-bordered w-full pl-10 focus:border-amber-500 bg-gray-800 text-white placeholder-gray-400";
  const selectClass =
    "select select-bordered w-full pl-10 focus:border-amber-500 bg-gray-800 text-white";
  const textareaClass =
    "textarea textarea-bordered w-full pl-10 h-24 focus:border-amber-500 bg-gray-800 text-white placeholder-gray-400";
          ...
          >
            ...
            <div className="form-control relative" ref={calendarContainerRef}>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  // Updated this button to match the dark input style
                  className={`input input-bordered w-full pl-10 flex items-center text-left focus:border-amber-500 bg-gray-800 text-white ${!formData.date ? "text-gray-400" : ""}`}
                >
            ...
            <div className="form-control md:col-span-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Official_meetup">Official meetup</option>
                  <option value="Wedding_ceremony">Wedding ceremony</option>
                  <option value="Baby shower">Baby_shower</option>
            ...
            <div className="md:col-span-2 mt-4">
              <button
                type="submit"
                disabled={loading}
                className="btn w-full bg-gray-900 text-amber-500 border-none hover:bg-gray-800 uppercase tracking-widest"
              >
