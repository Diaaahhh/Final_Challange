    ...
    <div className="flex items-center justify-center min-h-screen bg-[#0E1014] relative overflow-hidden font-['Inter']">
      ...
      <div className="w-full max-w-md p-8 bg-[#1F2125] border border-white/10 rounded-[4px] shadow-2xl relative z-10 mx-4">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-['Barlow_Condensed'] font-bold text-white  tracking-wider mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="form-control">
            <label className="label pl-0">
              <span className="label-text font-['Barlow_Condensed']  tracking-wide text-[#C59D5F] font-bold">Full Name</span>
            </label>
          ...
          <div className="form-control">
            <label className="label pl-0">
              <span className="label-text font-['Barlow_Condensed']  tracking-wide text-[#C59D5F] font-bold">Email Address</span>
            </label>
          ...
          <div className="form-control">
            <label className="label pl-0">
              <span className="label-text font-['Barlow_Condensed']  tracking-wide text-[#C59D5F] font-bold">Password</span>
            </label>
          ...
          <div className="mt-8">
            <button className="btn w-full bg-[#C59D5F] hover:bg-white hover:text-[#0E1014] text-white border-none font-['Barlow_Condensed'] font-bold  tracking-wider text-lg rounded-[4px] transition-all duration-300">Sign Up</button>
          </div>
        </form>

        <div className="mt-8 text-center pt-6 border-t border-white/10">
          <p className="text-gray-400 text-sm">Already have an account? <Link to="/login" className="text-[#C59D5F] font-bold hover:text-white transition-colors  font-['Barlow_Condensed'] tracking-wide ml-1">Login Here</Link></p>
        </div>
      </div>
    </div>
  );
